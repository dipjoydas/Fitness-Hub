    ...
    <div>
      ...
      <div className="cardClasses  lg:my-20 lg:mx-20">
        <div className="card relative m-auto sm:mx-4 card-compact bg-base-100 shadow-xl">
          <img className="h-[400px] rounded-2xl hover:scale-110 ease-in duration-100 cursor-pointer" src={image1} alt="Shoes" />
        ...
        <div className="card  relative m-auto sm:mx-4 card-compact  bg-base-100 shadow-xl">
          <img className="h-[400px] rounded-2xl hover:scale-110 ease-in duration-100 cursor-pointer" src={image2} alt="Shoes" />
          <div className="card-body cardBody1 text-[#ffffff] absolute ml-4 mt-[300px]">
        ...
        <div className="card  relative m-auto sm:mx-4 card-compact  bg-base-100 shadow-xl">
          <img className="h-[400px] rounded-2xl hover:scale-110 ease-in duration-100 cursor-pointer" src={image3} alt="Shoes" />
          <div className="card-body cardBody1 text-[#ffffff] absolute ml-4 mt-[300px]">
