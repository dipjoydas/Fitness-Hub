    ...
    <div>
      <div className="flex mx-6 flex-col text-center relative items-center">
        ...
        <p className="text-[#b1aeae] mx-8 mb-8 font-medium text-[15px] ">
          Fitness hub an unknown printer took a galley of type and scrambled
          <br /> make a type specimen book.
        </p>
      </div>
      <div className="homeBlogCard mx-4 mb-16 ">
        <div className="bg-gray-700 mb-4 max-w-sm m-auto rounded-lg overflow-hidden shadow-2xl">
          <div className="m-8 ">
            <h4 className="my-4">
