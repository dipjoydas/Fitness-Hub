        ...
        <div className="flex flex-col gap-3">
          <ul className=" dayCard  ">
            ...
            <li className="p-[25px]   ">
              ...
              <p className="text-[18px] text-black font-bold mt-3">Joy</p>
            </li>
            <li className="py-[25px] px-[55px] ">
          ...
          <ul className=" dayCard  ">
            ...
            <li className="p-[25px]   ">
              <p className="text-[14px] font-medium text-[#4d4b4b]">Trainer</p>
              <p className="text-[18px] text-black font-bold mt-3">Anamica</p>
            </li>
            <li className="py-[25px] px-[55px] ">
              <button className="text-white text-[15px] font-medium bg-[#555] py-[10px] px-[20px] rounded-[30px] mt-3 hover:bg-[#ff0336] ease-in duration-200 ">
                Join Now
          ...
          <ul className=" dayCard  ">
            ...
            <li className="p-[25px]   ">
              <p className="text-[14px] font-medium text-[#4d4b4b]">Trainer</p>
              <p className="text-[18px] text-black font-bold mt-3">Hossain</p>
            </li>
            <li className="py-[25px] px-[55px] ">
              <button className="text-white text-[15px] font-medium bg-[#555] py-[10px] px-[20px] rounded-[30px] mt-3 hover:bg-[#ff0336] ease-in duration-200 ">
                Join Now
